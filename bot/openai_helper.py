...
GPT_4_128K_MODELS = ("gpt-4-1106-preview","gpt-4-0125-preview","gpt-4-turbo-preview","gpt-4o")
...
def are_functions_available(model: str) -> bool:
    ...
    if model in ("gpt-3.5-turbo-0301", "gpt-4-0314", "gpt-4-32k-0314"):
        return False
    # Stable model GPT-4O will be updated to support functions on May 13, 2024
    # if model in ("gpt-4o"):
    #    return datetime.date.today() > datetime.date(2024, 5, 13)
    # Stable models will be updated to support functions on June 27, 2023
    if model in ("gpt-3.5-turbo", "gpt-3.5-turbo-1106", "gpt-4", "gpt-4-32k","gpt-4-1106-preview","gpt-4-0125-preview","gpt-4-turbo-preview", "gpt-4o"):
